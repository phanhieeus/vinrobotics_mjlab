...
class PlayConfig:
    ...
    base_actor_checkpoint: str | None = None
    """Override the base_actor_checkpoint in the registered rl_cfg (ResidualPPO tasks only)."""
...
def run_play(task_id: str, cfg: PlayConfig):
    ...
    if DUMMY_MODE:
        ...
        if cfg.base_actor_checkpoint is not None:
            agent_cfg_dict["base_actor_checkpoint"] = cfg.base_actor_checkpoint
    ...
    if resume_path:
        ...
        runner.export_policy_to_jit(export_model_dir)
        runner.export_policy_to_onnx(export_model_dir)
